...
const base =
  "group/cta relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-lg font-semibold transition-all duration-200 ease-out active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ffb454]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] disabled:pointer-events-none disabled:opacity-50 motion-reduce:transition-none motion-reduce:hover:translate-y-0"
...
const variants = {
  primary:
    "bg-[#ffb454] text-[#0a0a0a] shadow-[0_4px_22px_-6px_rgba(255,180,84,0.55)] hover:-translate-y-0.5 hover:bg-[#ffc47a] hover:shadow-[0_14px_40px_-8px_rgba(255,180,84,0.7)]",
  secondary:
